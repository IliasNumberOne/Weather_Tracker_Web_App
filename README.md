# Weather Tracker Web App <img src="src/main/webapp/images/weather-app.png" alt="icon" width="50" height="50" style="vertical-align: middle; position: relative; top: 10px;">
