# Weather Tracker Web App <img src="src/main/webapp/images/weather-app.png" alt="icon" width="50" height="50" style="display: inline-block; position: relative; top: 95px;">
